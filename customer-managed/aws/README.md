...
4. [Minimum permissions](https://github.com/redpanda-data/cloud-examples/customer-managed/aws/modules/aws-terraform/examples/iam_rpk_user.tf) in that 
...
The [terraform code](https://github.com/redpanda-data/cloud-examples/customer-managed/aws/modules/aws-terraform/examples) contains the 
...
[iam_rpk_user.tf](https://github.com/redpanda-data/cloud-examples/customer-managed/aws/modules/aws-terraform/examples/iam_rpk_user.tf) file 
